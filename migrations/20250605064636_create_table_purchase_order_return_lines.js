exports.up = knex => {
  return knex
    ...
    .then(() => knex.schema.hasTable("purchase_order_return_line"))
    .then(exists => {
      if (!exists) {
        return knex.schema.createTable("purchase_order_return_line", table => {
          table
            .uuid("po_line_id")
            .primary()
            .notNullable()
          ...
          table
            .string("rp_number")
            .notNullable()
            .references("rp_number")
            .inTable("purchase_order_return")
            .onDelete("CASCADE");
...
exports.down = knex => {
  return knex.schema.dropTable("purchase_order_return_line");
};
